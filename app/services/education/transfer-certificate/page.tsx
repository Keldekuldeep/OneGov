    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-[#2c5282] to-[#3b82f6] text-white py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Transfer Certificate</h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">Apply for school/college transfer certificate online</p>
        </div>
      </section>
