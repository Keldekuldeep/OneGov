...
interface RevenueRedirectModalProps {
  isOpen: boolean
  onClose: () => void
  onConfirm: () => void
  serviceName: string
...
export default function RevenueRedirectModal({ 
  isOpen, 
  onClose, 
  onConfirm, 
  serviceName,
  stateName 
}: RevenueRedirectModalProps) {
        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              You are being redirected to the official <span className="font-medium text-gray-900">{stateName}</span> State Revenue Department portal for <span className="font-medium text-gray-900">{serviceName}</span>.
            </p>
          </div>
